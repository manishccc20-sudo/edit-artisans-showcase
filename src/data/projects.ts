...
import showreelVideoAsset from "@/assets/manish-dasari-showreel.webm.asset.json";
import portrait from "@/assets/portrait.jpg.asset.json";
import portfolio01Video from "@/assets/portfolio-01.webm.asset.json";
import portfolio02Video from "@/assets/portfolio-02.webm.asset.json";
import portfolio03Video from "@/assets/portfolio-03.webm.asset.json";
import portfolio04Video from "@/assets/portfolio-04.webm.asset.json";
import portfolio05Video from "@/assets/portfolio-05.webm.asset.json";
import portfolio06Video from "@/assets/portfolio-06.webm.asset.json";
import portfolio07Video from "@/assets/portfolio-07.webm.asset.json";
import portfolio08Video from "@/assets/portfolio-08.webm.asset.json";
import portfolio09Video from "@/assets/portfolio-09.webm.asset.json";
import portfolio10Video from "@/assets/portfolio-10.webm.asset.json";
import portfolio11Video from "@/assets/portfolio-11.webm.asset.json";
import portfolio12Video from "@/assets/portfolio-12.webm.asset.json";
import portfolio13Video from "@/assets/portfolio-13.webm.asset.json";
import portfolio14Video from "@/assets/portfolio-14.webm.asset.json";
import portfolio15Video from "@/assets/portfolio-15.webm.asset.json";
import portfolio16Video from "@/assets/portfolio-16.webm.asset.json";
import portfolio17Video from "@/assets/portfolio-17.webm.asset.json";
import portfolio18Video from "@/assets/portfolio-18.webm.asset.json";
import portfolio19Video from "@/assets/portfolio-19.webm.asset.json";
...
import portfolio20Thumb from "@/assets/portfolio-20-thumb.jpg.asset.json";
import portfolio21Thumb from "@/assets/portfolio-21-thumb.jpg.asset.json";
...
export const projects: Project[] = seeds.map(([title, category, reelUrl], i) => ({
  ...
  category,
  reelUrl,
  videoUrl: i === 0 ? portfolio01Video.url : i === 1 ? portfolio02Video.url : i === 2 ? portfolio03Video.url : i === 3 ? portfolio04Video.url : i === 4 ? portfolio10Video.url : i === 5 ? portfolio13Video.url : i === 6 ? portfolio07Video.url : i === 7 ? portfolio08Video.url : i === 8 ? portfolio09Video.url : i === 9 ? portfolio05Video.url : i === 10 ? portfolio11Video.url : i === 11 ? portfolio12Video.url : i === 12 ? portfolio06Video.url : i === 13 ? portfolio14Video.url : i === 14 ? portfolio15Video.url : i === 15 ? portfolio16Video.url : i === 16 ? portfolio17Video.url : i === 17 ? portfolio18Video.url : i === 18 ? portfolio19Video.url : i === 19 ? portfolio20Video.url : i === 20 ? portfolio21Video.url : undefined,
  poster: i === 0 ? portfolio01Thumb.url : i === 1 ? portfolio02Thumb.url : i === 2 ? portfolio03Thumb.url : i === 3 ? portfolio04Thumb.url : i === 4 ? portfolio10Thumb.url : i === 5 ? portfolio13Thumb.url : i === 6 ? portfolio07Thumb.url : i === 7 ? portfolio08Thumb.url : i === 8 ? portfolio09Thumb.url : i === 9 ? portfolio05Thumb.url : i === 10 ? portfolio11Thumb.url : i === 11 ? portfolio12Thumb.url : i === 12 ? portfolio06Thumb.url : i === 13 ? portfolio14Thumb.url : i === 14 ? portfolio15Thumb.url : i === 15 ? portfolio16Thumb.url : i === 16 ? portfolio17Thumb.url : i === 17 ? portfolio18Thumb.url : i === 18 ? portfolio19Thumb.url : i === 19 ? portfolio20Thumb.url : i === 20 ? portfolio21Thumb.url : posters[i % posters.length]!,
